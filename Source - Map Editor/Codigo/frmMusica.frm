...
Begin VB.Form frmMusica 
   ...
   Begin FenixWorldEditor.lvButtons_H cmdCerrar 
      Height          =   495
      Left            =   2880
      TabIndex        =   4
      Top             =   1320
      ...
      cBack           =   -2147483633
   End
   Begin FenixWorldEditor.lvButtons_H cmdAplicarYCerrar 
      Height          =   495
      Left            =   2880
      TabIndex        =   3
      Top             =   720
      ...
      cBack           =   12648447
   End
   Begin FenixWorldEditor.lvButtons_H cmdDetener 
      Height          =   495
      Left            =   4080
      TabIndex        =   2
      Top             =   120
      ...
      cBack           =   12632319
   End
   Begin FenixWorldEditor.lvButtons_H cmdEscuchar 
      Height          =   495
      Left            =   2880
      TabIndex        =   1
      Top             =   120
