...
Open Path For Binary As #1
    ...
    For Y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 1 Then InfoTile = InfoTile Or 16
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 2 Then InfoTile = InfoTile Or 32
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 4 Then InfoTile = InfoTile Or 64
...
Open Path For Binary As #2
    ...
    For Y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 1 Then InfoTile = InfoTile Or 4
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 2 Then InfoTile = InfoTile Or 8
            If MapData(X, Y).Trigger = MapData(X, Y).Trigger And 4 Then InfoTile = InfoTile Or 16
