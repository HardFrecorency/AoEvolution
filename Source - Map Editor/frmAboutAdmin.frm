...
Begin VB.Form frmAbout1 
   ...
   Begin VB.PictureBox picIcon 
      ...
      Height          =   540
      Left            =   240
      Picture         =   "frmAboutAdmin.frx":0000
      ScaleHeight     =   337.12
      ScaleMode       =   0  'User
      ScaleWidth      =   337.12
      TabIndex        =   1
...
Private Sub Form_Load()
    ...
    lblDescription.Caption = "Tile adminnistration tool coded by mOrGoLoCk."
    lblDisclaimer.Caption = "This program has been made only for internal use."
End Sub
